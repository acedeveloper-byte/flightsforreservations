    ...
    <footer className='footer pt-5 text-white mt-5'>
      <Container>
        <Row className="gy-4">
          ...
          <Col md={5}>
            ...
            <Form className="d-flex flex-column flex-sm-row gap-2">
              <Form.Control type="email" placeholder="Your Email" className="rounded" />
              <Button variant="danger" className="px-4">Subscribe</Button>
            </Form>
          </Col>
        </Row>
        ...
        <div className="text-center mt-3 small">
          ...
          <a href="/terms-and-conditions" className="text-light text-decoration-none mx-2">Terms of Use</a>|
          <a href="/privacy-policy" className="text-light text-decoration-none mx-2">Privacy</a>
        </div>
      </Container>
    </footer>
  );
